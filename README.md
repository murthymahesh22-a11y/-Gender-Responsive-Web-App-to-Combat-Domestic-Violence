...
SEO & getting indexed by search engines

1. Replace placeholders

  - In `website/index.html`, replace every `REPLACE_WITH_LIVE_URL` with your final published site URL (for example: `https://murthymahesh22-a11y.github.io/-Gender-Responsive-Web-App-to-Combat-Domestic-Violence`).
  - In `website/robots.txt` and `website/sitemap.xml` replace the same placeholder.

2. Commit & push the changes

```powershell
cd 'C:\Users\muert\OneDrive\Desktop\Gender-Responsive Web App to Combat Domestic Violenc'
git add website/index.html website/robots.txt website/sitemap.xml
git commit -m "Add SEO meta tags, robots.txt and sitemap"
git push
```

3. Verify GitHub Pages deployment

- After push, check the Actions tab to ensure the `deploy-website` workflow ran successfully and created/updated the `gh-pages` branch. Your site should be live at the URL you used in placeholders.

4. Submit to search engines

- Google Search Console: add your site, submit the sitemap (`https://your-site/sitemap.xml`) and request indexing.
- Bing Webmaster: add your site and submit the sitemap.

5. Monitor and improve

- Use Google Search Console performance reports to monitor indexing and queries.
- Improve title/meta description for pages, add meaningful content and accessibility attributes to improve search ranking.
